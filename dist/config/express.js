...
var _client = require('../server/routes/client.route');

var _client2 = _interopRequireDefault(_client);

var _manager = require('../server/routes/manager.route');
...
if (_config2.default.env === 'development') {
  ...
  _raven2.default.config('__DSN__').install();
...
app.use('/client_api', _client2.default);
app.use('/manager_api', _manager2.default);
app.get('/api_docs', function (req, res) {
  res.sendFile(_path2.default.join(__dirname, '../../apidoc', 'index.html'));
});
